    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {products.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <a href="/products" className="mt-6 inline-flex items-center justify-center rounded-lg bg-primary-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-primary-700">
            Clear Filters
          </a>
        </div>
      )}
